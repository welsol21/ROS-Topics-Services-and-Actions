...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "controller",
            default_value="",  # Empty by default - no controller spawned automatically
            description="Controller to activate (forward_position_controller or joint_trajectory_controller)",
        ),
    ]
    ...
    # Spawners for controllers (joint state broadcaster + optional controller)
    ...
    controller_spawner = TimerAction(
        ...
        actions=[
            Node(
                ...
                condition=LaunchConfigurationNotEquals("controller", ""),
                output="screen",
            )
        ],
    )
